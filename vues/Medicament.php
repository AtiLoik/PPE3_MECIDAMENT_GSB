...
<div name="droite" style="float:left;width:80%;">
	...
	<form name="formMEDICAMENT" method="post" action="recupMEDICAMENT.php">
		...
		<label class="titre">&nbsp;</label><input class="zone" type="button" value="<"></input><input class="zone" type="button" value=">"></input><input type="submit" name="valider" value="Ajouter">
=======
<div id="page">
	<div id="content">
		<div class="box">
...
>>>>>>> ab7d141c881c699c57151e7b6fe8737a7665b7c6
	</form>
			</section>
		</div>
	</div>
